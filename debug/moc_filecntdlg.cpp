...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_FileCntDlg_t, stringdata0) + ofs), len 
...
const QMetaObject FileCntDlg::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_FileCntDlg.offsetsAndSize,
