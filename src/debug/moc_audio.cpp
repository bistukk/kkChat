...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_Audio_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_Audio_t qt_meta_stringdata_Audio = {
    {
QT_MOC_LITERAL(0, 5) // "Audio"
...
const QMetaObject Audio::staticMetaObject = { {
    ...
    qt_meta_stringdata_Audio.offsetsAndSize,
    qt_meta_data_Audio,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_Audio_t
