...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_FileSrvDlg_t, stringdata0) + ofs), len 
...
const QMetaObject FileSrvDlg::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_FileSrvDlg.offsetsAndSize,
    qt_meta_data_FileSrvDlg,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_FileSrvDlg_t
, QtPrivate::TypeAndForceComplete<FileSrvDlg, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<QString, std::false_type>
